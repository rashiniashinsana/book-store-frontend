...
const AddBookPopup: React.FC<AddFlowerPopUpProps> = ({ visible, onClose, onSave }) => {
  ...
  const handleSave = () => {
    ...
    console.log("Saved Book Data:", flowerData);
    onSave(flowerData);
    onClose();
  };
    ...
    <Modal visible={visible} animationType="slide" transparent={true} onRequestClose={onClose}>
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <TextInput label="Book Name" value={flowerName} onChangeText={setFlowerName} style={styles.input} />
